  ...
  const faqItems = [
    {
      ...
      answer: "Once you join, your funds will be allocated to our automated rasta-trendier strategy. The algorithm will trade on your behalf using proven technical indicators and risk management protocols. You'll have access to a dashboard where you can monitor performance in real-time.",
      delay: "delay-400"
    },
    {
      question: "What is the minimum amount to start?",
      answer: "The minimum amount to start is $100 USD. There is no maximum limit on your capital, and you can add funds anytime.",
      delay: "delay-500"
    },
    {
    ...
    },
    {
      ...
      answer: "You can withdraw your funds at any time from your dashboard. Withdrawal requests are processed within 24-48 hours, and funds will be sent to your designated account. There are no withdrawal fees or lock-up periods.",
      delay: "delay-700"
    },
    {
